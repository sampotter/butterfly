...
BfMat *bfGetHelm2KernelMatrix(BfPoints2 const *Xsrc, BfPoints2 const *Xtgt, BfVectors2 const *Nsrc, BfVectors2 const *Ntgt, BfReal K, BfLayerPotential layerPot, BfComplex const *alpha, BfComplex const *beta);
