...
BF_STUB(void, MatGivensComplexScaleRows, BfMat *, BfVec const *)
...
BF_STUB(BfVec *, MatGivensComplexForwardSolveVec, BfMat const *, BfVec const *)
...
BF_STUB(BfMat *, MatGivensComplexCholesky, BfMat const *)
